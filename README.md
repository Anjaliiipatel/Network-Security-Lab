...
# Tools Used
Wireshark, Nmap, hping3, Telnet, Slowloris (Python), SSH/PuTTY, Linux, Apache Web Server
...
_Investigated address resolution and domain queries to identify spoofing risks_
